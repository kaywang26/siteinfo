...
Siteinfo_app.py is a Windows command line application written in Python 3.

How to run: 
    siteinfo_app.py the_url
    e.g. siteinfo_app.py www.walmart.ca
    
This application will print following information of a given url:
